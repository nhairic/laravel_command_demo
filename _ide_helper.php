...
namespace {
	...
	class Text extends \Tool\LoremIpsumGeneratorFacade{
		/**
		 * 
		 *
		 * @static 
		 */
		 public static function __construct($wordsPer = 100){
			//Method inherited from \Tool\LoremIpsumGenerator
			 \Tool\LoremIpsumGenerator::__construct($wordsPer);
		 }
		 ...
		 * @static 
		 */
		 public static function getContent($count, $format = 'html', $loremipsum = true){
			//Method inherited from \Tool\LoremIpsumGenerator
			 \Tool\LoremIpsumGenerator::getContent($count, $format, $loremipsum);
		 }
